...
# The toolset is an archive of all the built dependencies.
...
TOOLSET_VOLNAME=gtk4mac_v$TOOLSET_VER

# A disk image containing a built version of the whole toolset.
# https://github.com/dehesselle/gtk4_macos
TOOLSET_URL=https://github.com/dehesselle/gtk4_macos/releases/download/\
